 ...
 * @version 1.0.0
 */
public class ImJsonMappingExceptionMapper implements ExceptionMapper<JsonMappingException>  {

    Logger logger = LoggerFactory.getLogger(ImJsonMappingExceptionMapper.class);
