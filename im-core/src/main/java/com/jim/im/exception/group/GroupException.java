 ...
 */
package com.jim.im.exception.group;
...
public class GroupException extends ImException {
     ...
     */
    public GroupException(String message, Throwable cause, boolean enableSuppression,
