 ...
 */
public class ProductionCertPushyTest {
    ...
    public static void main(final String[] args) throws Exception {
        ...
        final ApnsClient<SimpleApnsPushNotification> apnsClient = new ApnsClient<>(AppTest.class.getResourceAsStream("/cert/fabu.p12"), "111111");
        
//        final ApnsClient<SimpleApnsPushNotification> apnsClient = new ApnsClient<SimpleApnsPushNotification>(SSLContextUtil.createDefaultSSLContext("", "111111"), null);
...
//            final String token = TokenUtil.sanitizeTokenString("694294c641276563218c21d0a58770a2af3ad9b73c5c70af5d7bec0c40eba383");//error token
            final String token = TokenUtil.sanitizeTokenString("76dfd63df6914c06dadfb1b91498805fa35b3786e2c57ef1a8bea29e030b930d");//production token

//            pushNotification = new SimpleApnsPushNotification(token, "com.example.myApp", payload);
            pushNotification = new SimpleApnsPushNotification(token, "com.GuangZhouXuanWu.iphoneEtion", payload);
        }
